...
While this lecture will take place on a board, here is some accompanying material:
...
code) that does not support c++11. However, a much more recent version
can be loaded with
...
folder to your PATH. Note: you need to do this everytime you start a new terminal.
...
file from the git repo:
    ...
    wget https://github.com/ColonnaLab/EMBO_popgen/raw/main/popgen2023/Daniel_Wegmann/ABCDemo.tar.gz
...
Do you notice something? Not very surprisingly, we can not estimate N and mu
