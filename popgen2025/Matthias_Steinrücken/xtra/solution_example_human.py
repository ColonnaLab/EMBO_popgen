...
def repeat_simulations(mut, sample_sizes, length, reco, num_simulations, seed=None):
    ...
    # Asian data
    # 25_000 individuals at present
    # 3_000 individuals before 3_200 generations ago
    # 10_000 individuals another 600 generations ago
    demography = msprime.Demography()
    demography.add_population(name="A", initial_size=25_000)
    demography.add_population_parameters_change(population="A", time=3200, initial_size=3_000)
    demography.add_population_parameters_change(population="A", time=3800, initial_size=10_000)
...
results = repeat_simulations(mut, sample_sizes, length, reco, num_simulations, seed=seed)
