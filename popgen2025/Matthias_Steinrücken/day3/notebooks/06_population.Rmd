...
\end{equation}
where $\frac{1}{B(\alpha,\beta)}$ is simply a normalisation term which does not depend on $p$. Furthermore, for $\alpha = \beta = 1$, this is the uniform distribution, and thus yields a non-informative prior.
